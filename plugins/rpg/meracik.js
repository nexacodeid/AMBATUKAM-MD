             ...
             let type = (args[0] || '').toLowerCase()
                 switch (type) {
                     case 'ramuan': 
                                     ...
                                     let __waktuga = (Date.now() - global.db.data.users[m.sender].lastramuanclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastramuanclaim > 600000) {
                                     ...
                                     global.db.data.users[m.sender].lastramuanclaim = Date.now()
                                     let srcs = `
...
`.trim()
                     ...
                     case 'potion':
                                     ...
                                     let __waktution = (Date.now() - global.db.data.users[m.sender].lastpotionclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastpotionclaim > 600000) {
                                     if (global.db.data.users[m.sender].mangga > 499) {
                                 	if (global.db.data.users[m.sender].apel > 499) {
                                 	if (global.db.data.users[m.sender].pisang > 499) {
                                 	if (global.db.data.users[m.sender].jeruk > 499) {
                                     ...
                                     global.db.data.users[m.sender].lastpotionclaim = Date.now()
                                     let srcn = `
...
`.trim()
                     ...
                     case 'string':
                                     ...
                                     let __waktutiong = (Date.now() - global.db.data.users[m.sender].laststringclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].laststringclaim > 600000) {
                                     if (global.db.data.users[m.sender].mangga > 499) {
                                 	if (global.db.data.users[m.sender].apel > 499) {
                                 	if (global.db.data.users[m.sender].pisang > 499) {
                                 	if (global.db.data.users[m.sender].jeruk > 499) {
                                     ...
                                     global.db.data.users[m.sender].laststringclaim = Date.now()
                                     let srcng = `
...
`.trim()
                     ...
                     case 'sword':
                                     ...
                                     let __waktutions = (Date.now() - global.db.data.users[m.sender].lastswordclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastswordclaim > 600000) {
                                     ...
                                     global.db.data.users[m.sender].lastswordclaim = Date.now()
                                     let srcngs = `
...
`.trim()
                     ...
                     case 'weapon':
                                     ...
                                     let __waktutionsw = (Date.now() - global.db.data.users[m.sender].lastweaponclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastweaponclaim > 600000) {
                           ...
                           //          let weaponnw = (_weaponnw * 1)
                                     ...
                                     global.db.data.users[m.sender].lastweaponclaim = Date.now()
                                     let srcngsw = `
...
`.trim()
                     ...
                     case 'iron':
                                     ...
                                     let __waktutionsk = (Date.now() - global.db.data.users[m.sender].lastsironclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastsironclaim > 600000) {
                                     ...
                                     global.db.data.users[m.sender].lastsironclaim = Date.now()
                                     let srcngsk = `
...
`.trim()
                     ...
                     case 'pancingan':
                                     ...
                                     let __waktutionskh = (Date.now() - global.db.data.users[m.sender].lastsmancingclaim)
                                     ...
                                     if (Date.now() - global.db.data.users[m.sender].lastsmancingclaim > 600000) {
                                     if (global.db.data.users[m.sender].kayu > 499) {
                                 	if (global.db.data.users[m.sender].string > 4) {
                                     ...
                                     global.db.data.users[m.sender].lastsmancingclaim = Date.now()
                                     let srcngsk = `
