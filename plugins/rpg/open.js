    ...
    switch (type) {
        case 'common':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastime = (Date.now() - global.db.data.users[m.sender].lastopen)
                    let _lastime = (30000 - __lastime) 
                    let lastime = clockString(_lastime)
                    if (Date.now() - global.db.data.users[m.sender].lastopen > 30000) {
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1) {
                        ...
                        global.db.data.users[m.sender].lastopen = Date.now()
                ...
                break
                case '10':
                    let __lastimeq = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimeqq = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimeqqq = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
        ...
        case 'uncommon':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimew = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '10':
                    let __lastimewe = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimewee = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimeweee = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
        ...
        case 'mythic':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimep = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '10':
                    let __lastimepa = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimepaa = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimepaaa = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
        ...
        case 'boxs':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimed = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 1) {
                        ...
                        global.db.data.users[m.sender].emas += ebz * 1
                ...
                break
                case '10': 
                    let __lastimedo = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 10) {
                        ...
                        global.db.data.users[m.sender].emas += ebe * 1
                ...
                break
                case '100':
                    let __lastimedoo = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 100) {
                        ...
                        global.db.data.users[m.sender].emas += ebk * 1
                ...
                break
                case '1000':
                    let __lastimedooo = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 1000) {
                        ...
                        global.db.data.users[m.sender].emas += ebo * 1
       ...
       case 'gardenboxs':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimedz = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
                ...
                case '10':
                case 'crate':
                    let __lastimedzx = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
            	...
            	case '100':
                  case 'crate':
                    let __lastimedzxy = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
    			...
    			case '1000':
                 case 'crate':
                    let __lastimedzxk = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()
        ...
        case 'cupon':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimeki = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()*/
                ...
                break
                case '10':
                    let __lastimekise = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()*/
        ...
        case 'legendary':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimel = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()  
                ...
                break
                case '10':
                    let __lastimele = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()  
                ...
                break
                case '100':
                    let __lastimelee = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()  
                ...
                break
                case '1000':
                    let __lastimeleee = (Date.now() - global.db.data.users[m.sender].lastopen)
...
`.trim()  
        ...
        case 'pet':
            ...
            let __lastimepet = (Date.now() - global.db.data.users[m.sender].lastopen)
