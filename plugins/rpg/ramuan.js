...
let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    switch (type) {
        case 'rubah':
            ...
            let __waktur = (Date.now() - global.db.data.users[m.sender].ramuanrubahlast)
            let _waktur = (600000 - __waktur)
            let waktur = clockString(_waktur)
            if (Date.now() - global.db.data.users[m.sender].ramuanrubahlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    ...
                    global.db.data.users[m.sender].ramuanrubahlast = Date.now()
        ...
        case 'kuda':
            ...
            let __waktuk = (Date.now() - global.db.data.users[m.sender].ramuankudalast)
            let _waktuk = (600000 - __waktuk)
            let waktuk = clockString(_waktuk)
            if (Date.now() - global.db.data.users[m.sender].ramuankudalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakkuda += 200
                    global.db.data.users[m.sender].ramuankudalast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'serigala':
            ...
            let __waktus = (Date.now() - global.db.data.users[m.sender].ramuanserigalalast)
            let _waktus = (600000 - __waktus)
            let waktus = clockString(_waktus)
            if (Date.now() - global.db.data.users[m.sender].ramuanserigalalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakserigala += 200
                    global.db.data.users[m.sender].ramuanserigalalast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'naga':
            ...
            let __waktug = (Date.now() - global.db.data.users[m.sender].ramuannagalast)
            let _waktug = (600000 - __waktug)
            let waktug = clockString(_waktug)
            if (Date.now() - global.db.data.users[m.sender].ramuannagalast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anaknaga += 200
                    global.db.data.users[m.sender].ramuannagalast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
      ...
      case 'kyubi':
            ...
            let __waktuyu = (Date.now() - global.db.data.users[m.sender].ramuankyubilast)
            let _waktuyu = (600000 - __waktuyu)
            let waktuyu = clockString(_waktuyu)
            if (Date.now() - global.db.data.users[m.sender].ramuankyubilast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakkyubi += 200
                    global.db.data.users[m.sender].ramuankyubilast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
      ...
      case 'centaur':
            ...
            let __waktuur = (Date.now() - global.db.data.users[m.sender].ramuancentaurlast)
            let _waktuur = (600000 - __waktuur)
            let waktuur = clockString(_waktuur)
            if (Date.now() - global.db.data.users[m.sender].ramuancentaurlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakcentaur += 200
                    global.db.data.users[m.sender].ramuancentaurlast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
         ...
         case 'phonix':
            ...
            let __waktux = (Date.now() - global.db.data.users[m.sender].ramuanphonixlast)
            let _waktux = (600000 - __waktux)
            let waktux = clockString(_waktux)
            if (Date.now() - global.db.data.users[m.sender].ramuanphonixlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakphonix += 200
                    global.db.data.users[m.sender].ramuanphonixlast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'griffin':
            ...
            let __waktufin = (Date.now() - global.db.data.users[m.sender].ramuangriffinlast)
            let _waktufin = (600000 - __waktufin)
            let waktufin = clockString(_waktufin)
            if (Date.now() - global.db.data.users[m.sender].ramuangriffinlast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakgriffin += 200
                    global.db.data.users[m.sender].ramuangriffinlast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'kucing':
            ...
            let __waktu = (Date.now() - global.db.data.users[m.sender].ramuankucinglast)
            let _waktu = (600000 - __waktu)
            let waktu = clockString(_waktu)
            if (Date.now() - global.db.data.users[m.sender].ramuankucinglast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].anakkucing += 200
                    global.db.data.users[m.sender].ramuankucinglast = Date.now()
                    conn.reply(m.chat, `Berhasil Memberi Ramuan Ke Pet ${type}`, m)
                    setTimeout(() => {
        ...
        case 'hero':
            ...
            let __waktuher = (Date.now() - global.db.data.users[m.sender].ramuanherolast)
            let _waktuher = (600000 - __waktuher)
            let waktuher = clockString(_waktuher)
            if (Date.now() - global.db.data.users[m.sender].ramuanherolast > 600000) {
                if (global.db.data.users[m.sender].ramuan > 0) {
                    global.db.data.users[m.sender].ramuan -= 1
                    global.db.data.users[m.sender].exphero += 100
                    global.db.data.users[m.sender].ramuanherolast = Date.now()
