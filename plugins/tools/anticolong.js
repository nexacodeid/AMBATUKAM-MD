...
let handler = async (m, { conn }) => {
  try {
    ...
    console.log("âœ… Sticker berhasil diberi EXIF/atribut dan dikirim ulang");
  } catch (e) {
    console.error("âŒ Error inject sticker metadata:", e);
    await conn.sendMessage(
...
handler.command = /^(setattr|stattr|anticolong)$/i;
